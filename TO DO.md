...
## 1. Scheduled Payment **Development done**
...
2. Few bill dates are different, Let's take phone recharge usually they're providing 84d, 56d, 7d like 
that how can a user provide scheduled cycle here

## 2. Insurance **Development done**
...
## 3. Credit Card tracking **Development done**
